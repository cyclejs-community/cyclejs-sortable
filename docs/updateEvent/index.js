...
function Child(_a) {
    var DOM = _a.DOM;
    var vdom$ = xstream_1.default.of(dom_1.ul('.ul', [
...
function main(sources) {
    ...
    var vdom$ = xstream_1.default
        .combine(sinks.DOM, sinks.dragging, sinks.updateLive.startWith(undefined), sinks.updateDone.startWith(undefined))
        .map(function (_a) {
        var childDOM = _a[0], isDragging = _a[1], lastUpdate = _a[2], update = _a[3];
        return dom_1.div([
            ...
            update
                ...
                : dom_1.p(['Last completed reordering: none'])
        ]);
    });
    return {
        DOM: vdom$
...
},{"../../../src/makeSortable":7,"@cycle/dom":18,"@cycle/run":28,"xstream":122}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function mousedownHandler(node, ev, opts) {
    ...
    var children = node.children
        ...
        .concat(createGhost(indexClicked, ev, item, node.children[indexClicked]));
    return [
        __assign({}, helpers_1.addDataEntry(node, 'style', __assign({}, exports.selectNames
            .map(function (n) {
            return (_a = {}, _a[n] = 'none', _a);
            var _a;
        })
            .reduce(function (a, c) { return (__assign({}, a, c)); }, {}), { position: 'relative' })), { children: children }),
        undefined
    ];
}
...
function mousemoveHandler(node, ev, opts) {
    var item = node.children
        .map(function (n) { return n.data.dataset.item; })
    ...
    children[children.length - 1] = updateGhost(children[children.length - 1], ev);
    return [
...
function getIntersectionArea(rectA, rectB) {
    var a = Math.min(rectA.right, rectB.right) - Math.max(rectA.left, rectB.left);
    a = a < 0 ? 0 : a;
    var area = a *
...
function getIntersection(ghost, elm, upper) {
    ...
    var aRight = __assign({}, a, { left: a.right - (a.right - a.left) * f });
    var aBottom = __assign({}, a, { top: a.bottom - (a.bottom - a.top) * f });
    var bLeft = __assign({}, b, { right: b.left + (b.right - b.left) * f });
    var bTop = __assign({}, b, { bottom: b.top + (b.bottom - b.top) * f });
    var area = getIntersectionArea(aRight, bLeft) + getIntersectionArea(aBottom, bTop);
    return area < 0 ? 0 : area;
}
function updateGhost(node, ev) {
    var _c = node.data.dataset, offsetX = _c.offsetX, offsetY = _c.offsetY;
...
function mouseupHandler(node, ev, opts) {
    ...
    return [
        __assign({}, deleteData(node, 'style', ['position'].concat(mousedown_1.selectNames), true), { children: children }),
        undefined
    ];
}
...
function deleteData(node, mod, keys, b) {
    ...
    return __assign({}, node, { data: __assign({}, node.data, (_a = {}, _a[mod] = obj, _a)) });
    var _a;
}

},{"./mousedown":3}],6:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
function addKeys(node) {
    return __assign({}, node, { children: node.children.map(function (n, i) { return (__assign({}, n, { key: n.key ? n.key : '_sortable' + i })); }) });
}
exports.addKeys = addKeys;
function addDataEntry(node, key, values) {
    return __assign({}, node, { data: __assign({}, node.data, (_a = {}, _a[key] = __assign({}, (node.data ? node.data[key] : {}), values), _a)) });
    var _a;
}
...
function toSortable(options) {
    return function (component) { return makeSortable(component, options); };
}
...
function makeSortable(main, options) {
    return function (sources) {
        ...
        var down$ = getMouseStream(sources[options.DOMDriverKey], ['mousedown', 'touchstart'], options.handle || options.itemSelector);
        var up$ = getMouseStream(sources[options.DOMDriverKey], ['mouseleave', 'mouseup', 'touchend'], 'body');
        var move$ = getMouseStream(sources[options.DOMDriverKey], ['mousemove', 'touchmove'], 'body');
        var mousedown$ = down$
            .map(function (ev) {
        ...
        var mouseup$ = mousedown$
            .map(function (_) { return up$.take(1); })
            .flatten();
        var mousemove$ = mousedown$
            .map(function (start) { return move$.endWhen(mouseup$); })
            .flatten();
        var data$ = childDOM$
            .map(function (dom) {
            return xstream_1.default
        ...
        var updateAccumulated$ = mousedown$
            .map(function () {
            return updateOrder$
                .fold(function (acc, curr) { return ({
                indexMap: acc.indexMap
                    ? Object.keys(acc.indexMap)
                        .map(function (k) {
                        return (_a = {},
                            _a[k] = curr.indexMap[acc.indexMap[k]],
                            _a);
                        var _a;
                    })
                        .reduce(function (a, c) { return (__assign({}, a, c)); }, {})
                    : curr.indexMap,
                oldIndex: acc.oldIndex === -1
                    ? curr.oldIndex
                    : acc.oldIndex,
        ...
        var updateDone$ = mouseup$
            .compose(sampleCombine_1.default(updateAccumulated$))
            .map(function (_a) {
            var _ = _a[0], x = _a[1];
            return x;
        });
        var dragInProgress$ = xstream_1.default
            ...
            .fold(function (acc) { return !acc; }, false);
        return __assign({}, sinks, { DOM: adapt_1.adapt(vdom$), dragging: adapt_1.adapt(dragInProgress$), updateLive: adapt_1.adapt(updateOrder$), updateDone: adapt_1.adapt(updateDone$) });
    };
}
exports.makeSortable = makeSortable;
function getMouseStream(DOM, eventTypes, handle) {
    return xstream_1.default.merge.apply(xstream_1.default, eventTypes
        .slice(0, -1)
        .map(function (ev) { return xstream_1.default.fromObservable(DOM.select(handle).events(ev)); }).concat([xstream_1.default
            .fromObservable(DOM.select(handle).events(eventTypes[eventTypes.length - 1]))
            .map(augmentEvent)]));
}
...
},{"./eventHandler":2,"./helpers":6,"@cycle/run/lib/adapt":26,"xstream":122,"xstream/extra/delay":120,"xstream/extra/sampleCombine":121}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"./fromEvent":16,"@cycle/run/lib/adapt":26,"xstream":122}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"./fromEvent":16,"@cycle/run/lib/adapt":26,"xstream":122}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ScopeChecker":14,"./matchesSelector":21,"./utils":25}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var ScopeChecker_1 = require("./ScopeChecker");
...
},{"./ScopeChecker":14,"./fromEvent":16,"./matchesSelector":21,"./utils":25,"xstream":122}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./BodyDOMSource":8,"./DocumentDOMSource":9,"./ElementFinder":10,"./EventDelegator":11,"./fromEvent":16,"./isolate":19,"./utils":25,"@cycle/run/lib/adapt":26}],14:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./utils":25,"snabbdom-selector":97,"snabbdom/h":101,"snabbdom/vnode":112}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
...
},{"xstream":122}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"snabbdom/h":101}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./MainDOMSource":13,"./hyperscript-helpers":17,"./makeDOMDriver":20,"./mockDOMSource":22,"./thunk":24,"snabbdom/h":101}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var vnode_1 = require("snabbdom/vnode");
var utils_1 = require("./utils");
...
},{"./utils":25,"snabbdom/vnode":112}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./IsolateModule":12,"./MainDOMSource":13,"./VNodeWrapper":15,"./modules":23,"./utils":25,"es6-map/implement":81,"snabbdom":109,"snabbdom/tovnode":111,"xstream":122,"xstream/extra/concat":119,"xstream/extra/sampleCombine":121}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@cycle/run/lib/adapt":26,"xstream":122}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"snabbdom/modules/attributes":104,"snabbdom/modules/class":105,"snabbdom/modules/dataset":106,"snabbdom/modules/props":107,"snabbdom/modules/style":108}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var h_1 = require("snabbdom/h");
...
},{"snabbdom/h":101}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./adapt":27,"./microtask":29,"xstream":122}],29:[function(require,module,exports){
(function (process){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"_process":93}],30:[function(require,module,exports){
'use strict';
...
},{"./selectorParser":100}],95:[function(require,module,exports){
"use strict";
...
},{"./parent-symbol":98,"./query":99}],97:[function(require,module,exports){
"use strict";
...
},{"./classNameFromVNode":94,"./curry2":95,"./findMatches":96,"./selectorParser":100}],98:[function(require,module,exports){
(function (global){
"use strict";
var root;
...
},{"./classNameFromVNode":94,"./parent-symbol":98,"./selectorParser":100,"tree-selector":115}],100:[function(require,module,exports){
"use strict";
...
},{"./is":103,"./vnode":112}],102:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./h":101,"./htmldomapi":102,"./is":103,"./thunk":110,"./vnode":112}],110:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var h_1 = require("./h");
...
},{"./h":101}],111:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var vnode_1 = require("./vnode");
var htmldomapi_1 = require("./htmldomapi");
...
},{"./htmldomapi":102,"./vnode":112}],112:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./matches":116,"./querySelector":117,"./selectorParser":118}],116:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var selectorParser_1 = require("./selectorParser");
...
},{"./selectorParser":118}],117:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var selectorParser_1 = require("./selectorParser");
var matches_1 = require("./matches");
...
},{"./matches":116,"./selectorParser":118}],118:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"../index":122}],120:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var index_1 = require("../index");
...
},{"../index":122}],121:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var index_1 = require("../index");
var NO = {};
...
},{"../index":122}],122:[function(require,module,exports){
"use strict";
